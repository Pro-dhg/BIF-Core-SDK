...
public class root_zone_deploy {
     ...
     * 部署代码文件位置
     */
    public static String fileName = "D:\\air\\BIF-Core-SDK\\test\\src\\main\\data\\root_zone.js";
    /**
     * identity初始化参数 owner设置
     */
    public static String registerCommissionInitInput = "{\"rootZone\": \"\",\"owner\":\"did:bid:ef28Wz8twCynVe6PAnamLYCAFJYgJSnMh\"}";
