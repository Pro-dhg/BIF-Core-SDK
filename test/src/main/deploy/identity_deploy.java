...
public class identity_deploy {
     ...
     * 部署代码文件位置
     */
    public static String fileName = "D:\\air\\BIF-Core-SDK\\test\\src\\main\\data\\identity.js";
    /**
     * identity初始化参数 owner设置
     */
    public static String identityInitInput = "{\"owner\": \"did:bid:efJmpzPvG76ktDykMtzKVMAEForBiw6c\"}";
    ...
    public static void main(String[] args) throws Exception {
        ...
        createCReq.setInitInput(identityInitInput);
