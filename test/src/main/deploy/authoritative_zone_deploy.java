 ...
 * 部署账号要有足够的XHT
 */
public class authoritative_zone_deploy {
    /**
     * 测试网址
     */
     ...
     * 部署代码文件位置
     */
    public static String fileName = "D:\\air\\BIF-Core-SDK\\test\\src\\main\\data\\authoritative_zone.js";
    /**
     * identity初始化参数 owner设置
     */
    public static String registerCommissionInitInput = "{\"administrator\": \"\",\"authoritativeZone\":{\"owner\":\"did:bid:ef28Wz8twCynVe6PAnamLYCAFJYgJSnMh\"}}";
